...
// ✅ FIX: Dùng __dirname để đảm bảo đọc đúng file dù process.cwd() thay đổi khi restart/redeploy
const DB = {
    coins:     path.join(__dirname, "coins.json"),
    blacklist: path.join(__dirname, "blacklist.json"),
    top:       path.join(__dirname, "top.json"),
    register:  path.join(__dirname, "register.json"),
    staff:     path.join(__dirname, "staff.json"),
    mainers:   path.join(__dirname, "mainers.json"),
    strike:    path.join(__dirname, "strike.json"),
    daily:     path.join(__dirname, "daily.json"),
